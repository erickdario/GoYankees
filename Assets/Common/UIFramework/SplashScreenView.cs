...
public class SplashScreenView : ISampleAppUIView
{
    ...
    {
        mAndroidPotrait = Resources.Load("SplashScreen/AndroidPortrait") as Texture;
        mWindowsPlayModeTexture = Resources.Load("SplashScreen/WindowsPlayModePortrait") as Texture;
        mPotraitTextureIPhone = Resources.Load("SplashScreen/PortraitTextureIPhone") as Texture;
        mPotraitTextureIPhone5 = Resources.Load("SplashScreen/PortraitTextureIPhone5") as Texture;
        mPotraitTextureIPad = Resources.Load("SplashScreen/PortraitTextureIPad") as Texture;
    }

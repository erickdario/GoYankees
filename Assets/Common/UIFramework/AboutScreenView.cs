...
public class AboutScreenView : ISampleAppUIView
{
    ...
    public void LoadView ()
    {
		...
		mCenterBgStyle.normal.background = Resources.Load ("UserInterface/blueTexture") as Texture2D;
        ...
        if(Screen.dpi > 300 ){
			...
			Debug.Log(mUISkin.label.fontSize);
            mAboutTitleBgStyle.font = Resources.Load("SourceSansPro-Regular_big_xhdpi") as Font;
            mOKButtonBgStyle.font = Resources.Load("SourceSansPro-Regular_big_xhdpi") as Font;
        ...
        else
        {
			...
			mUISkin.label.font = Resources.Load("SourceSansPro-Regular_big") as Font;
    ...
    public void UpdateUI (bool tf)
    {
        ...
        GUI.Box(new Rect(ABOUT_TEXT_MARGIN * DeviceDependentScale,0,Screen.width,mAboutTitleHeight),"Go Yankees",mAboutTitleBgStyle);
        ...
        GUILayout.BeginArea(new Rect(0, mAboutTitleHeight,
                                 Screen.width,
		                             Screen.height - mAboutTitleHeight), mCenterBgStyle);
		...
		GUILayout.Button (Resources.Load ("UserInterface/logo") as Texture2D, mCenterBgStyle);
